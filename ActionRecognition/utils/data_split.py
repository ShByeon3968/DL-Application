...
def split_data():
    # CSV 파일을 읽어들입니다.
    input_csv = './data/test_3/merged_output.csv'  # 여기서 'input.csv'를 실제 입력 파일명으로 대체하세요
...
def convert_txt():
    # CSV 파일을 읽어들입니다.
    input_csv = './data/test.csv'  # 여기를 실제 파일 이름으로 변경하세요
    df = pd.read_csv(input_csv)

    # TXT 파일로 변환하여 저장합니다.
    output_txt = './data/test.txt'  # 원하는 출력 파일 이름으로 변경하세요
